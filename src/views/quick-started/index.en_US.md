...
| Checked controls such as Switch and Checkbox | `checked` / `onChange`  | `checked` initializes state, allows local interaction, and synchronizes external changes. Switch reports a value directly; Checkbox reports an object containing `checked`.                     |
| Overlays such as Modal and Drawer            | `open` / `onOpenChange` | `open` initializes visibility, allows local interaction, and synchronizes external changes.                                                                                                     |
