...
export default class start extends React.Component {
  ...
  render() {
    return <div className="demo-sponsor">
      ...
      <br />
      <p>
        <a href="https://gitee.com/chuchur/kui-react" target="_blank">GitHub</a> 赏个Star；</p>
      <p>
        <a href="http://gitee.com/chuchur/kui-react/pulls" target="_blank"> New pull request</a>，帮助KYUI做得更好；</p>
