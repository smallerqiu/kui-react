...
[Modern Enterprise Admin Console](./demo/enterprise-admin-console.tsx)
...
[Responsive Portal/Official Website Layout (Portal Exhibition)](./demo/portal-exhibition.tsx)
...
[Documentation/Knowledge Base Layout](./demo/documentation-layout.tsx)
...
[Task Workbench (The "Workbench" Details Layout)](./demo/workbench-layout.tsx)

- Left navigation + Middle dashboard + Right detail panel (Right Sider).

[Modern Enterprise Admin Console](./demo/messaging-collaboration.tsx)

- The most common "sidebar navigation + top toolbar" structure, suitable for SaaS products, CMS backends, or ERP systems.
- Layout logic: The outer Layout includes the Sider, while the inner Layout contains the Header, Content, and Footer.
- Matching components: Menu (vertical mode), Breadcrumb, Avatar.

[Visual Editor Layout (IDE / Low-code Layout)](./demo/low-code-layout.tsx)
