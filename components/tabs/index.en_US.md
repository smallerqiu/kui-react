...
[Browser-style Tabs](./demo/browser.tsx?show=vertical)
...
| extra | Extra content displayed on the right side of the tab bar | `React.ReactNode` | - |
...
| title | Content displayed in tab header | `React.ReactNode` | - |
