...
| onChange | Called when the active anchor changes | `((activeLink: string) => void)` | - |
| onClick | Called when an anchor is clicked | `((link: string) => void)` | - |
