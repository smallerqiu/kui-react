...
| shape | Shape of the QR code | `"round" \| "default" \| "square" \| "circle"` | `round` |
| theme | Theme of the QR code | `"dashed" \| "solid" \| "default" \| "fill" \| "outline" \| "plain" \| "underlined"` | `outline` |
...
| :------- | :-------------------------------------------------------------- | :------------------------------------- |
| download | Waits for the QR code and logo to finish, then downloads a PNG. | `(fileName?: string) => Promise<void>` |
