...
[Progress Bar](./demo/basic.tsx)

- A standard progress bar.

[Circular Progress](./demo/circle.tsx)

- A circular progress bar.

[Dashboard-style Progress Bar](./demo/dashboard.tsx)
...
[Dynamic Display](./demo/dynamic.tsx)

- A moving progress bar is a good progress bar.

[Color and Format](./demo/color.tsx)
...
| strokeLinecap | Progress bar style | `"round" \| "butt" \| "square"` | round |
| width | Circular progress bar canvas width, in px | `number` | - |
| size | When value is `small`, displays small size | `"small" \| "medium" \| "large"` | - |
| format | Custom progress bar text | `((percent: number) => React.ReactNode)` | - |
| status | Progress bar status, provides four types: `active`, `exception`, `success`, `normal` | `"normal" \| "active" \| "success" \| "exception"` | normal |
