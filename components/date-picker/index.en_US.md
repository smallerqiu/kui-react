...
| onStartDateChange | Triggered when the range start date changes                                                                                                       | (value: unknown) => void                                    | -          |
| onEndDateChange | Triggered when the range end date changes                                                                                                           | (value: unknown) => void                                    | -          |
