...
| open         | Controlled dropdown visibility                                                                                                                       | bool                                                        | -          |
| defaultOpen  | Initial dropdown visibility in uncontrolled mode                                                                                                     | bool                                                        | false      |
...
| bordered     | Whether to display the border                                                                                                                          | bool                                                        | true       |
| placement    | Direction displayed when pulled down                                                                                                                   | string                                                      | bottom-left |
| valueType    | The default type of the output value                                                                                                                   | ["date" ,"timestamp" , "unix" , "string"]                   | string     |
