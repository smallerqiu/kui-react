...
| theme | The component renders the theme | `"dashed" \| "solid" \| "default" \| "fill" \| "outline" \| "plain" \| "underlined"` | fill |
| shape | The shape in which the component is presented | `"round" \| "default" \| "square" \| "circle"` | circle |
