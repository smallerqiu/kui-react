...
[Affix to Bottom](./demo/bottom.tsx)
...
| target | Scroll target observed by Affix | `(() => HTMLElement \| Window \| null)` | window |
| onChange | Called when the affixed state changes | `((affixed: boolean) => void)` | - |
