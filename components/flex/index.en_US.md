...
| --- | --- | --- | --- |
| align | Cross-axis alignment | `"center" \| "end" \| "flex-end" \| "flex-start" \| "start" \| "baseline"` | `center` horizontally; `stretch` vertically |
| justify | Main-axis alignment | `"center" \| "space-around" \| "space-between" \| "space-evenly" \| "flex-end" \| "flex-start"` | `flex-start` |
